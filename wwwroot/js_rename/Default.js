...
//		return;
	...
	var source = $('<select class="Source" multiple="multiple" size="10">').createOptions(list, false);
	var selected = $('<select class="Selected" name="' + name + '" multiple="multiple" size="10">');
